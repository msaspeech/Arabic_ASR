...
from .seq2seq_cnn_attention import train_cnn_seq2seq_model, train_cnn_bidirectional_seq2seq_model
    ...
    def test_model(self):
        ...
        if file_exists(self.model_path):
            ...
            if self.word_level:
                ...
                self.model.evaluate_generator(self.split_data_generator_dict_char_level_test(), test_samples, verbose=1)
